            ...
            <div class="top-header">
                <div class="container">
                    <div class="top-header-left">
                        <ul class="support">
                            <li><a href="LiveChat.html"><label> </label></a></li>
                            <li><a href="LiveChat.html"><%=map.get("live_support")%><span class="live"></span></a>
            ...
            <ul class="menu">
                <li class="item1"><a href="error.jsp"><%=map.get("electronic")%></a>
                    <ul class="cute">
                        ...
                        <li class="subitem2"><a href="controller?action=getproduct&type=laptop">Laptop</a></li>
                        <li class="subitem3"><a href="tablet.jsp"><%=map.get("ipad")%></a></li>
                        <li class="subitem4"><a href="controller?action=getproduct&type=tivi">Tivi</a></li>
