...
<div class="modal fade" id="registerModal" role="dialog">
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal">&times;</button>
                <img src="images/regpic.png" class="center-block" height="130">
...
<div class="container">
    <div class="shoes-grid">
        <h1 ><%=map.get("view.title")%></h1>
        <div style="box-shadow: 10px 10px 5px #888888;"class="view-adjust banner-matter">
            <div class="col-md-5 banner-bag">




                <img style="margin-top: 60px" class="img-responsive " src="<%=temp.getUrl()%>" alt=" " />
            ...
            <div class="col-md-7 banner-off">							
                ...
                <% if (ush.getAccrole().equals(UserRole.GUEST)) {
                %> 
                <a href="login.jsp"><span class="on-get"><%=map.get("cart.warn")%></a></span>
                <%} else {%>
                ...
                <form name="addcartform">
                    ...
                    <input class="btn btn-lg btn-primary" type="button"
                           value="<%=map.get("add")%>" onclick="addToCart()">
