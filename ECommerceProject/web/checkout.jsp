    ...
    <div class="shoes-grid">
        ...
        <div>
            ...
            <div class="col-md-9 cart-items">
                <h1>My Shopping Bag (<%=cart.getProducts().size()%>)</h1>


                <%
                    ArrayList<pro> list = cart.getProducts();
                ...
                <div class="cart-header2">
                    ...
                    <div class="cart-sec simpleCart_shelfItem">
                        <div class="cart-item cyc">
                            <img src="<%=temp.getUrl()%>" class="img-responsive" alt=""/>
                        </div>
            ...
            <div><a href="controller?action=order"></a>order</div>
        </div>
        <div class="cart"><a href="controller?action=order"><span> </span>order</a></div>
        <div class="clearfix"> </div>
