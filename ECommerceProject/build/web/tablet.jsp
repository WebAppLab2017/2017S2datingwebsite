...
<html>
    ...
    <body> 
        ...
        <%
            ArrayList<pro> list = (ArrayList<pro>) session.getAttribute("product");
        %>
                    ...
                    <div class="col-md-6" style="border: 1px solid  #bfbfbf;">
                        ...
                        <div class="col-md-12">
                            <div class="col-md-6" style="word-break:break-all; ">
                                <p style="font-size: 120%"><b><%=temp.getName()%><b></p>
                                            <p style="color: red">$<%=temp.getPrice()%></p>
                                            <br>
                                            <a href="view.jsp?productId=<%=temp.getID_product()%>">
                                                <span class="on-get"><%=map.get("get")%></span>
                                            </a>
                                            </div>
                                            <div class="col-md-6" style="">
                                                <a href="controller?action=productDetail&id=<%=temp.getID_product()%>"><%=temp.getID_product()%>
                                                   
                                                        <img src="<%=temp.getUrl()%>" style="width: 150px ;height: 150px;">
